...
data=read.csv("/Users/yiz2014/Dropbox/Grant-and-IRB/AHRQ R03/Analysis/EDDC_18_89_med_HF_seq_task.csv",header=FALSE)
N=len(data)
#data2=subset(data,V2==3)  #subset clusters
#N is len of data
data_seq=seqdef(data[,3:30],left="DEL",right = "DEL",gaps="DEL")  #look at first 4 events in the sequence
